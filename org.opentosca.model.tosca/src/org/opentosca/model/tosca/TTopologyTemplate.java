...
public class TTopologyTemplate extends TExtensibleElements {
	 ...
	 * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the nodeTemplateOrRelationshipTemplate
	 * property.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link TNodeTemplate } {@link TRelationshipTemplate }
	 *
	 *
	 */
