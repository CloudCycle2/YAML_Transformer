...
@XmlSeeAlso({ TImport.class, TServiceTemplate.class, TNodeTypeImplementation.class, TRelationshipTypeImplementation.class,
		TOperation.class, TCapabilityDefinition.class, TPlan.class, TExtension.class, TDeploymentArtifact.class, TExtensions.class,
		TTopologyTemplate.class, TEntityType.class, TImplementationArtifact.class, TPolicy.class, TRequirementDefinition.class,
		TEntityTemplate.class, TDefinitions.class })
