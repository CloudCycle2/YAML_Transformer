...
public class PropertiesParserUtil {
     ...
     */
    public JAXBElement<AnyMap> getAnyMapForProperties(final Map<String, Object> customMap, final String nodeName) {
    ...
    private String parseGetter(Map<String, Object> getterMap) {
        ...
        for (Map.Entry<String, Object> getter : getterMap.entrySet()) {
