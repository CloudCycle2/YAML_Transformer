...
/**
 * This class supports the mapping/conversion of type names from YAML to XML. E.g. YAML BaseTypes for relationships are tosca.nodes.Root,
 * etc. and the corresponding ones in XML are RootRelationshipType, etc. The methods support BaseTypes as well as SpecificTypes for
 * YAML/XML.
 *
 * @author Sebi
 */
